...
const CategoryDetailPage = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50/30 via-white to-yellow-50/30 min-h-screen">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-yellow-50 via-amber-50 to-yellow-50 py-8 sm:py-12 border-b-2 border-amber-100 overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute -top-10 -left-10 w-72 h-72 bg-yellow-200/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-10 -right-10 w-96 h-96 bg-amber-200/20 rounded-full blur-3xl animate-pulse animation-delay-1000"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8">
            ...
            {category.mainImage && (
              <div className="w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 rounded-2xl overflow-hidden border-4 border-white shadow-2xl flex-shrink-0 transform hover:scale-105 transition-transform duration-300 animate-fade-in">
                <Image
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8 animate-fade-in-up animation-delay-200">
          ...
          >
            ...
            {(selectedMaterials.length > 0 ||
              ...
              <span className="ml-1 bg-gradient-to-r from-yellow-600 to-amber-600 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center shadow-md animate-bounce">
          ...
          <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="fixed inset-y-0 left-0 w-full sm:w-96 bg-white overflow-y-auto shadow-2xl animate-slide-in-left">
              ...
              <div className="px-4 pb-24">
                {/* Sort Options */}
                <div className="py-5 border-b border-amber-200 animate-fade-in-up animation-delay-100">
                ...
                {/* Price Range */}
                <div className="py-5 border-b border-amber-200 animate-fade-in-up animation-delay-200">
                  ...
                  {/* Price Display */}
                  <div className="mb-4 flex justify-between items-center text-sm bg-gradient-to-r from-amber-50 to-yellow-50 px-4 py-3 rounded-lg border-2 border-amber-200">
                ...
                {/* Materials */}
                {materials.length > 0 && (
                  <div className="py-5 border-b border-amber-200 animate-fade-in-up animation-delay-300">
                      ...
                      {materials.map((material) => (
                        ...
                        >
                          <input
                            ...
                            className="h-4 w-4 text-yellow-600 border-gray-300 rounded focus:ring-yellow-500 transition-all"
                          />
                ...
                {paintingStyles.length > 0 && (
                  <div className="py-5 border-b border-amber-200 animate-fade-in-up animation-delay-400">
                    <div className="flex justify-between items-center mb-3">
                      <h3 className="text-base font-semibold flex items-center">
                        <span className="w-2 h-2 bg-yellow-600 rounded-full mr-2"></span>
                        Painting Style
              ...
              <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t-2 border-amber-200 space-y-2 sm:w-96 shadow-2xl">
                <button
                  ...
                  className="w-full py-3 bg-white border-2 border-amber-300 text-amber-900 font-semibold rounded-xl hover:bg-amber-50 transition-all transform hover:scale-105"
                >
                  Reset Filters
                </button>
                <button
                  onClick={() => setMobileFiltersOpen(false)}
                  className="w-full py-3 bg-gradient-to-r from-yellow-600 to-amber-600 text-white font-semibold rounded-xl hover:from-yellow-700 hover:to-amber-700 transition-all shadow-lg transform hover:scale-105"
                >
        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
          ...
          <aside className="hidden lg:block w-80 flex-shrink-0 animate-fade-in-up animation-delay-300">
            <div className="bg-white p-6 rounded-2xl shadow-lg border-2 border-amber-100 sticky top-8 hover:shadow-xl transition-shadow">
              ...
              <div className="mb-6 pb-6 border-b-2 border-amber-100">
                ...
                <div className="mb-4 flex justify-between items-center text-sm bg-gradient-to-r from-amber-50 to-yellow-50 px-3 py-3 rounded-lg border-2 border-amber-200">
                  <span className="font-bold text-gray-900">
                    {formatIndianCurrency(priceRange[0])}
                  </span>
                  <span className="text-amber-600 font-bold">—</span>
          ...
          <div className="flex-grow">
            ...
            {(selectedMaterials.length > 0 ||
              ...
              priceRange[0] !== 0 ||
              priceRange[1] !== 50000) && (
              <div className="mb-4 sm:mb-6 flex flex-wrap gap-2 animate-fade-in-up animation-delay-400">
                {selectedMaterials.map((slug) => {
                  ...
                  return material ? (
                    <span
                      key={slug}
                      className="inline-flex items-center px-3 py-1.5 rounded-xl text-xs sm:text-sm font-semibold bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 border-2 border-yellow-300 hover:border-yellow-400 transition-all animate-fade-in"
                    >
                      {material.title}
                      <button
                ...
                {(priceRange[0] !== 0 || priceRange[1] !== 50000) && (
                  <span className="inline-flex items-center px-3 py-1.5 rounded-xl text-xs sm:text-sm font-semibold bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 border-2 border-yellow-300 hover:border-yellow-400 transition-all animate-fade-in">
                    {formatIndianCurrency(priceRange[0])} -{" "}
                    {formatIndianCurrency(priceRange[1])}
                    <button
                      onClick={() => {
            ...
            {/* Results Count */}
            <div className="mb-4 sm:mb-6 flex justify-between items-center text-sm sm:text-base bg-white px-5 py-4 rounded-xl border-2 border-amber-100 shadow-sm hover:shadow-md transition-shadow animate-fade-in-up animation-delay-500">
            ...
            {currentProducts.length === 0 ? (
              <div className="text-center py-16 bg-white rounded-2xl shadow-lg border-2 border-dashed border-amber-200 animate-fade-in">
                <div className="mx-auto w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-amber-100 to-yellow-100 rounded-full flex items-center justify-center mb-4 animate-pulse">
                ...
                <button
                  onClick={resetFilters}
                  className="px-6 py-3 bg-gradient-to-r from-yellow-600 to-amber-600 text-white font-semibold rounded-xl hover:from-yellow-700 hover:to-amber-700 transition-all shadow-lg text-sm sm:text-base transform hover:scale-105"
                >
                  Clear all filters
                </button>
              </div>
              ...
              <>
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
                  {currentProducts.map((product, index) => {
                    ...
                    return (
                      ...
                      >
                        <article className="bg-white rounded-2xl shadow-md hover:shadow-2xl overflow-hidden h-full flex flex-col transition-all duration-500 border-2 border-amber-100 hover:border-amber-300 transform hover:-translate-y-2">
                          {/* Product Image */}
                          <div className="relative w-full aspect-square overflow-hidden bg-gradient-to-br from-amber-50 to-yellow-50">
                            {product.mainImage ? (
                              <Image
                                ...
                                sizes="(max-width: 475px) 50vw, (max-width: 640px) 50vw, (max-width: 1024px) 33vw, 25vw"
                                loading="lazy"
                              />
                            ) : (
                            ...
                            {/* Badges */}
                            <div className="absolute top-2 left-2 right-2 sm:top-3 sm:left-3 sm:right-3 flex justify-between items-start gap-2">
                              {hasDiscount && (
                                <div className="bg-gradient-to-r from-red-500 to-pink-600 text-white text-[10px] sm:text-xs font-bold px-2 py-1 sm:px-2.5 sm:py-1.5 rounded-lg shadow-lg animate-pulse">
                                  {calculateDiscount(actualPrice!, price)}% OFF
                                </div>
                              )}
                              {product.featured && (
                                <div className="bg-gradient-to-r from-yellow-400 to-amber-500 text-white text-[10px] sm:text-xs font-bold px-2 py-1 sm:px-2.5 sm:py-1.5 rounded-lg flex items-center shadow-lg ml-auto">
                          ...
                          <div className="p-3 sm:p-4 lg:p-5 flex flex-col flex-grow">
                            <div className="flex-grow">
                              <h3 className="text-sm sm:text-base lg:text-lg font-bold text-gray-900 group-hover:text-yellow-700 transition-colors mb-1.5 sm:mb-2 line-clamp-2 leading-tight">
                                {product.name}
                              </h3>

                              {/* Dimensions - Hidden on mobile */}
                              {product.dimensions && (
                                <div className="hidden sm:block text-xs text-gray-600 mb-2 bg-amber-50 px-2.5 py-1.5 rounded-lg border border-amber-200 inline-block">
                            ...
                            <div className="mt-2 sm:mt-4 space-y-2 sm:space-y-3">
                              ...
                              <div className="flex gap-1.5 sm:gap-2 flex-wrap">
                                {product.paintingStyle && (
                                  <span className="inline-flex items-center px-2 py-1 sm:px-2.5 sm:py-1 rounded-md sm:rounded-lg text-[10px] sm:text-xs font-semibold bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 border border-yellow-300">
                                    {product.paintingStyle}
                                  </span>
                                )}
                                {product.material && (
                              ...
                              {/* View Button */}
                              <button className="w-full py-2 sm:py-2.5 px-3 sm:px-4 text-xs sm:text-sm font-semibold rounded-lg sm:rounded-xl text-white bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-700 hover:to-amber-700 transition-all shadow-md hover:shadow-lg transform hover:scale-105">
                                View Details
                              </button>
                            </div>
                          </div>
                ...
                {totalPages > 1 && (
                  <nav
                    className="mt-10 flex justify-center animate-fade-in-up animation-delay-600"
                    aria-label="Pagination"
                  >
                    <div className="flex items-center gap-1 sm:gap-2 bg-white rounded-xl shadow-lg overflow-hidden border-2 border-amber-200 p-2">
                      <button
                          ...
                          (_, i) => {
                            ...
                            return (
                              <button
                                ...
                                className={`w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg text-xs sm:text-sm font-bold transition-all ${
                                  currentPage === pageNum
                      ...
                      <div className="sm:hidden px-3 sm:px-4 py-2 text-xs sm:text-sm font-bold text-gray-700">
