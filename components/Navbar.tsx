...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/98 backdrop-blur-lg shadow-lg border-b-2 border-amber-100" : "bg-white border-b border-amber-100/50"}`}>
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="flex items-center justify-between h-20 sm:h-24 lg:h-28">
            
            {/* FIXED LARGE NAVBAR LOGO */}
            <Link href="/" className="relative flex-shrink-0 group" aria-label="RadhaRani Handicrafts Home">
              <div className="w-24 h-16 sm:w-32 sm:h-20 lg:w-40 lg:h-24 relative">
                <Image
                  src="/bg-logo.png"
            ...
            <div className="hidden lg:flex items-center space-x-1 xl:space-x-2">
              <Link href="/products" className="relative px-4 py-2 text-gray-700 hover:text-amber-700 font-semibold text-base transition-colors duration-200 group">
                Products
              ...
              <Link href="/categories" className="relative px-4 py-2 text-gray-700 hover:text-amber-700 font-semibold text-base transition-colors duration-200 group">
                Categories
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-600 to-amber-600 transition-all duration-300 group-hover:w-full rounded-full"></span>
              </Link>
              <Link href="/about" className="relative px-4 py-2 text-gray-700 hover:text-amber-700 font-semibold text-base transition-colors duration-200 group">
                About Us
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-600 to-amber-600 transition-all duration-300 group-hover:w-full rounded-full"></span>
              </Link>
              <Link href="/our-stores" className="relative px-4 py-2 text-gray-700 hover:text-amber-700 font-semibold text-base transition-colors duration-200 group">
                Our Stores
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-600 to-amber-600 transition-all duration-300 group-hover:w-full rounded-full"></span>
              </Link>
            </div>
      ...
      {/* Mobile Menu Drawer */}
      <div className={`fixed top-0 right-0 h-full w-full sm:w-96 bg-white z-50 transform transition-transform duration-300 ease-in-out lg:hidden shadow-2xl ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
