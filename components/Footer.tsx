...
import { Instagram, Facebook, Youtube, Phone, MapPin, Mail, Clock, Award, Sparkles } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div className="space-y-5 sm:col-span-2 lg:col-span-1">
            ...
            <Link href="/" className="inline-block group">
              <div className="relative w-48 h-16 sm:w-56 sm:h-18 transition-transform duration-300 group-hover:scale-105">
                <Image
                  src="/bg-logo.png"
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              ...
              <span className="font-bold text-amber-400">Jaipur Murti Bhandar</span>.
              Sacred marble idols handcrafted in Jaipur with generations of expertise.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                ...
                <span className="text-xs font-semibold text-amber-400">38+ Years</span>
              </div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                <Sparkles className="w-3.5 h-3.5 text-amber-400" />
                <span className="text-xs font-semibold text-amber-400">Authentic</span>
              </div>
            </div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start group">
                ...
                <address className="not-italic text-gray-400 group-hover:text-gray-300 transition-colors">
                  <span className="font-bold text-amber-400">Jaipur Murti Bhandar</span><br />
                  Pili Phokar, Agra<br />
                  Uttar Pradesh, India
                </address>
              </li>
              ...
              <li className="flex items-start group">
                ...
                <div className="text-gray-400 group-hover:text-gray-300 transition-colors">
                  <span className="font-semibold text-amber-400">Mon - Sat:</span> 9 AM - 7 PM<br />
                  <span className="font-semibold text-amber-400">Sunday:</span> Closed
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 mb-5 leading-relaxed">
              Have questions about our marble idols? Chat directly with our master artisans from Jaipur Murti Bhandar.
            </p>
            ...
            <div className="mt-5 p-4 bg-gradient-to-br from-amber-500/10 to-yellow-500/10 border border-amber-500/20 rounded-xl">
              <p className="text-xs text-gray-400 leading-relaxed">
                <span className="font-bold text-amber-400">🎨 Custom Orders Welcome!</span><br />
                We specialize in creating bespoke marble deities tailored to your spiritual needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <p className="text-xs text-gray-500 text-center sm:text-left">
              © {currentYear}{' '}
              <span className="font-bold text-amber-400">RadhaRani Handicrafts</span>
              {' '}• All rights reserved.
            </p>
